...
class MyPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create my_post" do
    assert_difference("MyPost.count") do
      post my_posts_url, params: { my_post: { author: @my_post.author, description: @my_post.description, kind: @my_post.kind, title: @my_post.title } }
    end
  ...
  test "should update my_post" do
    patch my_post_url(@my_post), params: { my_post: { author: @my_post.author, description: @my_post.description, kind: @my_post.kind, title: @my_post.title } }
